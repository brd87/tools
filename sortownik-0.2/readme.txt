...
4. Every another line after that should have domain name of the downloaded files (the whole part before "-") and
   directory where you want to move files from particular domain
...
- Only files from domain pbs.twimg.com (twitter) and scontent-waw1-1.xx.fbcdn.net (facebook) will be sorted